...
// grayscale layer
var grayscale = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-background/{z}/{x}/{y}{r}.{ext}', {
...
// variable to hold the tectonoic plates layer
...
.then(
    function(earthquakeData){
        ...
        // add on to the stle for each data point
